...
function History() {
  return (
<section className="">
  <div className="container px-5 md:px-10 py-12 lg:py-20 mx-auto flex flex-wrap bg-[#c1e8f1] bg-opacity-50">
    ...
    <div className="flex flex-col flex-wrap w-2/5 ">
      ...
      <p className="text-base sm:text-2xl lg:text-4xl w-full px-4 lg:px-10 lg:mb-14 mb-8">Парикмахерская "ЛУЧ" была основана в 1949 году молодыми, творческимим парикмахерами, дети и внуки которых, работают здесь по сей день. </p>
